  ...
  override predicate row(string row) {
    row =
      [
        ...
        "org.springframework.web.util;UriBuilder;true;query;;;Argument[-1];ReturnValue;taint",
        ...
        "org.springframework.web.util;UriBuilder;true;replaceQueryParams;;;Element of MapKey of Argument[0];ReturnValue;taint",
        "org.springframework.web.util;UriBuilder;true;replaceQueryParams;;;Element of MapValue of Argument[0];ReturnValue;taint",
        "org.springframework.web.util;UriBuilder;true;scheme;;;Argument[-1];ReturnValue;taint",
        ...
        "org.springframework.web.util;UriBuilder;true;userInfo;;;Argument[-1];ReturnValue;taint",
        ...
        //   that gets the writer used to write to it; should I link these up outside of the csv models?
        ...
        // note for review: adds a cookie (argument 1) to an `HttpServletResponse` (argument 0); whether a cookie should taint a response
        ...
        // for review: this is likely a good use for synthetic fields; should I use them and wait for that PR to be merged?
